...
export const aoriConfig: AoriSwapWidgetConfig = {
  ...
  tokens: {
    ...
    supportedInputTokens: [
      ...
      { chainId: 1, address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE' },     // ETH Ethereum
      ...
      { chainId: 10, address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE' },    // ETH Optimism
      ...
      { chainId: 8453, address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE' },  // ETH Base
      ...
      { chainId: 42161, address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE' }, // ETH Arbitrum
    ],
